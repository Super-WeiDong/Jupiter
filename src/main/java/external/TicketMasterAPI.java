package external;
/**
 * description HTTP request to TicketMaster API and get response
 * @author weidong wang
 * 2022/1/16
 */
...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "wWI8JoUCxtZXAcGJYxm2JHrR6lNm8G8Y";
	...
	private String getAddress(JSONObject event) throws JSONException {
		if (!event.isNull("_embedded")) {
			...
			if (!embedded.isNull("venues")) {
				...
				for (int i = 0; i < venues.length(); ++i) {//actually we just get first item
